...
public class Hard : MonoBehaviour
{
    ...
    private const int COMBO_START_GAIN = 10;
    ...
    private void CreateRubble(Vector3 pros, Vector3 scale)
    {
        GameObject go = GameObject.CreatePrimitive(PrimitiveType.Cube);
        go.transform.localPosition = pros;
    ...
    private bool PlaceTile()
    {
        ...
        if (isMovingOnX)
        {
            ...
            if (Mathf.Abs(deltaX) > ERROR_MARGIN)
            {
                ...
                CreateRubble
                    (
                    new Vector3((t.localPosition.x > 0)
